...
from .views import ProductListView, ProductDetailView, AdminProductCreateUpdateDeleteView,BulkUploadProductView
...
urlpatterns = [
    ...
    path('admin/products/', AdminProductCreateUpdateDeleteView.as_view(), name='admin-product-create'),
