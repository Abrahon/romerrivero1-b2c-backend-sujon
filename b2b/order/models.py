...
#     user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_order')  # Ensure related_name is correctly set
...
#     # prootal_spent = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
