...
from .views import ReviewListCreateAPIView, ReviewUpdateAPIView, ReviewDeleteAPIView,TopReviewsListView
...
urlpatterns = [
    ...
    path('top/reviews/', TopReviewsListView.as_view(), name='top-reviews'),
