...
class Order(TimeStampedModel):
    ...
    order_number = models.CharField(max_length=255, default='0000') 
    # order_number = models.CharField(max_length=64, unique=True, editable=False)
    shipping_address = models.TextField()
    total_amount = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal("0.00"))
    is_paid = models.BooleanField(default=False)
    # If you already have PaymentStatus enum, you can import and use it.
    ...
    def save(self, *args, **kwargs):
        if not self.order_number:
            # Human-friendly unique order id: YYYYMMDD-HHMM-<random>
