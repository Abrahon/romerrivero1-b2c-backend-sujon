...
# Google OAuth settings (use env vars)
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': os.getenv('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY', '649570633464-7p40grhfbe7o5347oq2244tvjr0kiv9v.apps.googleusercontent.com'),
            'secret': os.getenv('SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET', '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'),
            'key': '',
        }
    }
}
